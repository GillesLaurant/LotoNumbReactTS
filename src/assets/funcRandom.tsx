...
export function randomNumStr(max: number = 49) {
...
// CALCUL JACKPOT
export function getJackpot(arr: string[], max = 0, arrUser: string[] = [""]) {
  let arrCopy: string[] = arr;
  ...
  return arrCopy.sort((a: any, b: any) => a - b);
}

// CHECK VALUE IN ARRAY
export function checkValinArray(arrStr: string[], v: string) {
